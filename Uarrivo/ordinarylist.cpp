...
void ordinaryList :: insert(ordinary l, personal_info p, int location){
    ordinaryNode* newnode = new ordinaryNode;
    newnode->car = l;
    newnode->driver = p;
...
void ordinaryList::deletecar(string driversname){
    ordinaryNode* curr = head;
    ordinaryNode* prev;
...
int ordinaryList:: minDistance(int shortest_dist[], bool visited[])
{
...
int ordinaryList::dijkstra(int graph[6][6], int location, int destination)
{
...
ordinary ordinaryList::returnnearest(int location, int graph[6][6]){
    ordinaryNode* curr = head;
    int index = 0;
    int locationlist[2];
    int loca;
...
personal_info ordinaryList:: returndriver(int location, int graph[6][6]){
    ordinaryNode* curr = head;
    int index = 0;
    int locationlist[2];
    int loca;
...
int ordinaryList::returlocation(int location, int (*graph)[6]){
    ordinaryNode* curr = head;
    int index = 0;
    int locationlist[2];
    int loca;
