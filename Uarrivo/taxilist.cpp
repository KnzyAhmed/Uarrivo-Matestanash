...
void taxiList :: insert(taxi l, personal_info p, int location){
    taxiNode* newnode = new taxiNode;
    newnode->car = l;
    newnode->driver = p;
...
void taxiList::deletecar(string driversname){
    taxiNode* curr = head;
    taxiNode* prev;
...
int taxiList:: minDistance(int shortest_dist[], bool visited[])
{
...
int taxiList::dijkstra(int graph[6][6], int location, int destination)
{
...
taxi taxiList::returnnearest(int location, int graph[6][6]){
     taxiNode* curr = head;
     int index = 0;
     int locationlist[2];
     int loca;
...
personal_info taxiList:: returndriver(int location, int graph[6][6]){
    taxiNode* curr = head;
    int index = 0;
    int locationlist[2];
    int loca;
...
int taxiList::returlocation(int location, int (*graph)[6]){
    taxiNode* curr = head;
    int index = 0;
    int locationlist[2];
    int loca;
